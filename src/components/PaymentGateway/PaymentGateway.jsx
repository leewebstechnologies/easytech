            ...
            >
              ...
              <div className="text lg:mt-14 mt-5">
                ...
                <div className="body3 text-secondary lg:mt-6 mt-4">
                  Get personalized financial advice to help reach your financial goals. We provide reliable and secure payment gateway services for business of all sizes. With our cutting-edge technology and 24/7 customer support, you can easily accept payments from customers all over the world.
                </div>
              </div>
              <div className="button-block flex items-center max-sm:flex-wrap sm:gap-6 gap-3 lg:mt-12 mt-8 w-fit">
                <Link className="button-main box-shadow bg-blue-700 hover:bg-black text-white bg-blue whitespace-nowrap rounded-fill" href="/">
                Get Started
                </Link>
